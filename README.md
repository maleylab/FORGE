...
The current implementation is meant for internal use, however, it is public if others wish to modify it.

Currently the most basic functionality is operational. Our current effort is on completing the TSGen pipeline.
